...
export interface BeeMinterInterface extends utils.Interface {
  functions: {
    ...
    "mintBatchWithURI(address[],string[])": FunctionFragment;
    "mintWithURI(address,string)": FunctionFragment;
...
export interface BeeMinter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeeMinterInterface;
  ...
  functions: {
    ...
    mintBatchWithURI(
      ...
      _tokenURIList: PromiseOrValue<string>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
