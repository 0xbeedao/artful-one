...
interface TarotNFTDeckInterface extends ethers.utils.Interface {
  functions: {
...
export class TarotNFTDeck extends BaseContract {
  ...
  filters: {
    ...
    "Card(address,string,uint8,uint8)"(
      ...
      [string, string, number, number],
      { owner: string; uri: string; index: number; draw: number }
    >;
